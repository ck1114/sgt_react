        ...
        if (!this.state.editTracker){
            return(
                <tr>
                    ...
                    <td>{course}</td>
                    <td>{grade}</td>
                    <td><button onClick={()=>this.handleEdit()}>Edit</button><button onClick={()=>this.dataDel(studentId)}>Delete</button></td>
                </tr>
            )
        }
        else{
            return(
                <tr>
                    ...
                    <td><button onClick={()=>this.dataUpdate(studentId)}>Save</button><button onClick={()=>this.dataDel(studentId)}>Delete</button></td>
                </tr>
            )
        }
    }
